...
def create_database():
    con=driver.connect(host="localhost",user="root",passwd="622001",port="3306",charset='utf8')
    if con.is_connected():
...
def show_databases():
    con=driver.connect(host='localhost',user='root',passwd='622001',charset='utf8',port="3306")
    if con.is_connected():
        print("Successfully Connected")
    cur=con.cursor()
...
def create_stud_table():
    con=driver.connect(host='localhost',user='root',passwd='622001',charset='utf8',database='test',port="3306")
    if con.is_connected():
        print("Successfully Connected")
    cur=con.cursor()
